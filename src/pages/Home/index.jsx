...
export const Home = (props) => {
  ...
  return (
    <Box component="span" id="page">
    <Box component="span" id="home">
      ...
      <Box component="span" id="header">
        <NavgationBar/>
      </Box>

      <Box component="span" id="body">
      ...
      <Box component="span" id="footer">
        <Box component="span" className="containerImg">
